...
public class HIBEBBG05KeyPairGenerator implements PairingKeyPairGenerator {
    ...
    public PairingKeySerPair generateKeyPair() {
        ...
        Element h = g.powZn(r).getImmutable();
        ...
        return new PairingKeySerPair(
                new HIBEBBG05PublicKeySerParameter(this.parameters.getPairingParameters(), g, g1, g2, g3, hs, h),
                new HIBEBBG05MasterSecretKeySerParameter(this.parameters.getPairingParameters(), g2Alpha, r, s));
    }
}
